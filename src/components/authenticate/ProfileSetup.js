        ...
        <div className='flex flex-wrap -mx-3 mb-6'>
          ...
          <div className='w-full md:w-1/3 px-3 mb-6 md:mb-0'>
            ...
            <div className='relative'>
              <select
                className='block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-300 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500'
                id='grid-state'
                ref={petSizeRef}
              >
                <option>S</option>
