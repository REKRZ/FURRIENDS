...
const About = () => {
  return (
    <div>
      <div className='max-w-screen-xl px-4 mx-auto md:px-8 pb-4 pt-8 flex-grow'>
            ...
            <div className='flex flex-col items-center justify-center'>
              ...
              <div className='flex'>
                <div className='flex gap-4'>
                  <a target='_blank' href='https://www.linkedin.com/in/kenji-zhang/'>
                    <BsLinkedin />
                  </a>
      ...
      <section className='bg-bookmark-white pt-10 pb-20  items-center justify-center mt-4'>
        <div>
          ...
          <div className='sm:w-3/4 lg:w-5/12 mx-auto px-2'>
            ...
            <p className='text-center text-bookmark-grey mt-4'>Here are the answers to our FAQs!</p>
          </div>
          {/* <!-- FAQ Items --> */}
